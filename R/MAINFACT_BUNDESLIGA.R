#' Begegnungen Bundesliga
#'
#' Der Datensatz enthält alle Bundesligabegegnungen über einen Zeitraum von 11 Jahren - Saison 2005/2006 bis einschließlich Saison 2015/2016. Jeder Begegnung sind
...
#'
#' @docType data
#' @usage data(MAINFACT_BUNDESLIGA)
#'
#'
